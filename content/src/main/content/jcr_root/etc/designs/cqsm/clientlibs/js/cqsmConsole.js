 ...
 * =========================LICENSE_END==================================
 */
Cog.component.cqsmConsole = (function ($, helper, ace) {
    var api = {},
        console;
    ...
    api.init = function ($elements) {
        if ($elements.length) {
            console = new Console($elements.eq(0));
        }
    };

    return api;
}(COGjQuery, Cog.component.cqsmHelper, ace));

Cog.register({
    name: 'cqsmConsole',
    api: Cog.component.cqsmConsole,
    selector: '#cqsmConsolePage'
});
