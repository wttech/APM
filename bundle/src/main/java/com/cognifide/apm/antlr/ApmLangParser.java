...
public class ApmLangParser extends Parser {
		...
		try {
			...
			do {
				...
				case 1:
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
					if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << DEFINE_MACRO) | (1L << EXECUTE_MACRO) | (1L << IMPORT_SCRIPT) | (1L << FOR_EACH) | (1L << DEFINE) | (1L << IDENTIFIER) | (1L << COMMENT))) != 0)) {
						{
						setState(44);
						line();
						}
	...
	public static class ForeachContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ApmLangVisitor ) return ((ApmLangVisitor<? extends T>)visitor).visitForeach(this);
			else return visitor.visitChildren(this);
		}
	}
